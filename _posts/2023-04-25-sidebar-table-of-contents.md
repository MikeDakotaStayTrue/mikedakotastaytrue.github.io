...
It is necessary to check that the setInvalidatedByBiometricEnrollment option is not set to false. \
...
Useful [video](https://www.youtube.com/watch?v=uN6IocCyIF0&t=1207s).
